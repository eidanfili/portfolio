...
import AboutComponentRight from './about-component-right';
import AboutComponentLeft from './about-component-left';
            ...
            <div>
                ...
                <div className="about"> 
                    ...
                    <div className="about__right">
                        <AboutComponentRight imgURL="/assets/about/wrestling.jpg" content="I have wrestled for my highschool and have won awards for team leadership and dedication. I am also the orange county champion." />
                        <AboutComponentRight imgURL="/assets/about/age.jpg" content="I am currently 14 years old. I am also a freshman in highschool." />
                        <AboutComponentRight imgURL="/assets/about/edu.jpg" content="I learned to code React, Python, Flask, HTML and SCSS at Bottega tech.I am also currently in high school. I have a fullstack developement certificate" />
                    </div>
