            ...
            <div>
                ...
                <div className="projects ">
                    ...
                    <div className="projects__container">
                        ...
                        <ProjectComponent href="https://twitter.com/EidanLedezma?lang=en" icon="fas fa-arrow-circle-right" imgURL="/assets/projects/Capture.png" content="hi this is my mad lib app click the icon to visit the page!"/>
                    </div>
                </div>
                <Footer />
            </div>
